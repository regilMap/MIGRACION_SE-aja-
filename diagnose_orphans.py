...
def check_orphans():
    ...
    codigos = ['01.2', '01.5', '02.8', '01.4', '02.5', '01.1', '02.6', '05.05', '03.4', '05.04', '01.6', '02.1', '02.3', '02.2', '05.10', '02.4', '05.09', '05.02', '06.3', '01.3', '02.7', '06.5', '06.4', '05.01', '05.03', '05.07', 'Np', '07.1', '05.08', '03.3', 'Ns', '07.1', '06.1', '07.2']
