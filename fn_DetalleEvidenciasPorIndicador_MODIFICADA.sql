...
CREATE OR ALTER FUNCTION [dbo].[fn_DetalleEvidenciasPorIndicador]
(
    @IndicadorId INT,
    @CoedomId INT
)
...
(
    ...
    SELECT 
        ...
        CASE 
            ...
            -- Si es pendiente (sin archivos subidos), no mostrar fecha de vencimiento
            WHEN ua.UltimoArchivoId IS NULL THEN NULL
