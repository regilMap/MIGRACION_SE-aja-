...
def main():
    ...
    cursor = conn.cursor()
    try:
        # We will run the query of fn_DetalleIndicadoresOrganismo but changing the CAST for PesoSubDistribuido to DECIMAL(10,4)
        query = """
    DECLARE @CoedomId INT = 25903;
